            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">:: แก้ไขคำร้องขอพัฒนาระบบ ::</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <div class="col-sm-6">
                                      <select id="cate_id" name="cate_id" class="form-select" required>
                                       ...
                                       while ($row1 = mysqli_fetch_array($result1)) {
                                        if($row1['cate_id']==$row['cate_id']){ $select = "selected"; }else{  $select = "";  }
                                        echo '<option value="'.$row1['cate_id'].'" '.$select.'>'.$row1['cate_name'].'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <select id="sys_id" name="sys_id" class="form-select" required>
                                  ...
                                  while ($row1 = mysqli_fetch_array($result1)) {
                                     if($row1['sys_id']==$row['sys_id']){ $select = "selected"; }else{  $select = "";  }
                                     echo '<option value="'.$row1['sys_id'].'" '.$select.'>'.$row1['sys_name'].'</option>';
                                 }
                                 ?>
                             </select>
                         </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="dev_title" name="dev_title" placeholder="ระบุหัวเรื่อง" value="<?=$row['dev_title']?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cono1" readonly value="<?=$row['fname'].' '.$row['lname']?>" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="dev_detail" class="col-sm-2 text-end control-label col-form-label">รายละเอียด : </label>
                        <div class="col-sm-9">
                            <textarea name="dev_detail" class="form-control"  placeholder="ระบุรายละเอียด/ความต้องการ" ><?=$row['dev_detail']?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="cono1"
                    ...
                    <input type="hidden" name="method" value="edit_approve">
